...
$gatewayModuleName = paykassa_get_module_name();
...
if ($status === 'yes') {
    ...
    $invoiceCurrencyCode = paykassa_get_invoice_currency_code($invoiceId);
    $paymentAmount = paykassa_convert_amount($amount, $currency, $invoiceCurrencyCode);
    $paymentFee = paykassa_convert_amount($fee, $currency, $invoiceCurrencyCode);
